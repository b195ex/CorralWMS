...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="table-responsive">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" DataKeyNames="Id" DataSourceID="ReqDataSrc" GridLines="None" 
            OnRowDataBound="GridView1_RowDataBound" OnPreRender="Grid_PreRender" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" EmptyDataText="No hay traslados que mostrar.">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Detalle">
                    <ItemTemplate>
                        <asp:GridView ID="DtlGrid" runat="server" CssClass="table table-condensed table-striped" AutoGenerateColumns="False" DataSourceID="DtlDataSrc" GridLines="None" 
                        ...
                        <asp:SqlDataSource ID="DtlDataSrc" runat="server" 
                            ConnectionString="<%# CorralWMS.Tools.Util.GetCtxConnStr() %>" ProviderName="System.Data.SqlClient" 
        ...
        <asp:SqlDataSource ID="ReqDataSrc" runat="server" ConnectionString="<%# CorralWMS.Tools.Util.GetCtxConnStr() %>" 
